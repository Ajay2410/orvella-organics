    ...
    <header className="sticky top-0 z-50 bg-white h-[84px] flex items-center border-b border-[#E8E0D5] px-4 sm:px-6 lg:px-20">
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          <a href="https://wa.me/919714280780" target="_blank" rel="noreferrer" className="text-[#25D366] hover:opacity-80 transition-opacity hidden md:flex items-center justify-center">
